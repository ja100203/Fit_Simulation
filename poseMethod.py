...
#             cv2.circle(resized_frame, (x1,y1), 15, (0,0,255))
#             cv2.circle(resized_frame, (x2,y2), 10, (0,0,255), cv2.FILLED)
#             cv2.circle(resized_frame, (x2,y2), 15, (0,0,255))
#             cv2.circle(resized_frame, (x3,y3), 10, (0,0,255), cv2.FILLED)
#             cv2.circle(resized_frame, (x3,y3), 15, (0,0,255))

#             #cv2.putText(resized_frame, str(int(angle)), (x2-50, y2+50), cv2.FONT_HERSHEY_COMPLEX, 2,(0,0,255),2)
